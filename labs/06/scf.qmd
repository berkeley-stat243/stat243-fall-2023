...
1. Call `sbatch submitBoot.sh` to execute the R script `boot.R`.

2. Check that the execution worked by examining the `.Rout` file.

3. Time allowing: Update the parallel code to use the `future` package
