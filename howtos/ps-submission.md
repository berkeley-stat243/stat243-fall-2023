...
Here we outline a few suggested workflows for developing your problem set solutions:
 ...
 2. Use VS Code with the following extensions: Python, Quarto, and Jupyter Notebooks. This allows you to execute and preview chunks inside VS Code. This is currently deeb's favorite path due to how well it integrated with the Python debugger.
