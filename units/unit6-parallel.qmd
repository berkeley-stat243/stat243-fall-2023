...
For parallel (threaded) linear algebra in Python, one can use an optimized BLAS with the `numpy` and
...
We could do this similarly with Tensorflow or JAX.
