...
include numbers, white space, and special characters, stored as an object
of the `str` class.

## String processing and regular expressions in Python

[UNDER CONSTRUCTION: insert material from string processing tutorial]
...
We'll work on these challenges (and perhaps one or two others) in class.

1.  What regex would I use to find any number with or without a decimal place (done as part of Unit 3).

2.  Suppose a text string has dates in the form "Aug-3", "May-9", etc.
    and I want them in the form "3 Aug", "9 May", etc. How would I do
    this regex?

3.  Suppose I want to remove HTML tags such as <br> and </br> from a string such as
    ""Do an internship <b> in place </b> of <b> one </b> course.". How
    can I remove only those tags and not any other text?
